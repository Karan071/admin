...
import { CollegesTable} from "@/data/Data";
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        <h1 className="text-2xl font-bold text-[var(--text-head)]">Colleges</h1>
        <StatsCards />
   <Topbar  />
...
function TableSection() {
  ...
  const [selectedStack, setSelectedStack] = useState<
    typeof CollegesTable
  >(CollegesTable[0] ? [CollegesTable[0]] : []);
  const [focusedId, setFocusedId] = useState<string | null>(CollegesTable[0]?.id || null);

  // Sorting logic
  const sortedData = [...CollegesTable];
  if (sortConfig !== null) {
    sortedData.sort((a, b) => {
  ...
  const handleRowClick = (user: (typeof CollegesTable)[0]) => {
              ...
              {currentRecords.map((user) => (
                ...
                >
                  ...
                  <TableCell>
                    ...
                    <TableCell>
                    <div className="text-low">{user.Degree}</div>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                   ...
                   <TableCell>
                    <div className="text-low">{user.UpcomingDate}</div>
                  </TableCell>
