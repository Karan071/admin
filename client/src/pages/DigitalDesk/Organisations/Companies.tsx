...
import {CompaniesTables } from "@/data/Data";
...
function TableSection() {
  ...
  const [selectedStack, setSelectedStack] = useState<
    typeof CompaniesTables
  >(CompaniesTables[0] ? [CompaniesTables[0]] : []);
  const [focusedId, setFocusedId] = useState<string | null>(CompaniesTables[0]?.id || null);

  // Sorting logic
  const sortedData = [...CompaniesTables];
  if (sortConfig !== null) {
    sortedData.sort((a, b) => {
  ...
  const handleRowClick = (user: (typeof CompaniesTables)[0]) => {
