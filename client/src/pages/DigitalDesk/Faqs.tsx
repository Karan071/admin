          ...
          <Table className="w-full caption-top border-collapse overflow-y-visible">
            <TableHeader className="bg-[var(--faded)] hover:bg-[var(--faded)] dark:bg-[var(--faded)] opacity-100">
              <TableRow>
                ...
                <TableHead className="text-[var(--text)]">Page Title</TableHead>
                <TableHead className="text-[var(--text)]">For</TableHead>
                <TableHead className="text-[var(--text)]">Questions</TableHead>
        ...
        <div className="flex items-center justify-between flex-wrap gap-2 p-4">
          <div className="flex items-center gap-4">
            ...
            <span className="text-low text-[var(--text)]">
              ...
              {Math.min(indexOfLastRecord, filteredData.length)} of {filteredData.length} FAQs
            </span>
          </div>
          <div className="flex items-center gap-2 ">
            <Button
