...
import { Users, UserCheck, UserPlus, Plus, Trash2, Funnel, ChevronDown, Eye, Flag, MessageCircle, Search, ChevronLeft, ChevronRight} from "lucide-react"
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
                ...
                <Table className="w-full caption-top border-collapse overflow-y-visible">
                    <TableHeader className="bg-[var(--faded)] hover:bg-[var(--faded)] dark:bg-[var(--faded)] opacity-100">
                        <TableRow>
                            ...
                            <TableHead className="text-[var(--text)]">Priority</TableHead>
                        ...
                        {currentRecords.map((bugs) => (
                            ...
                            >
                                ...
                                <TableCell>
                                    <Badge
                                        variant={
                                            bugs.status === "Resolved" ? "brand" : "standard"
                                        }
                                    >
                                        {bugs.status}
                                    </Badge>
